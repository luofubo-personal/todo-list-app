...
describe('TodoItemComponent', () => {
  ...
  describe('Urgency detection', () => {
    it('should detect urgent todo (less than 24 hours)', () => {
      ...
      // Trigger ngOnChanges manually since it's not called automatically in tests
  ...
  describe('Template rendering', () => {
    ...
    it('should show countdown when not completed and has time remaining', () => {
      const deadline = new Date();
      deadline.setDate(deadline.getDate() + 2); // Make it non-urgent to avoid change detection issues
